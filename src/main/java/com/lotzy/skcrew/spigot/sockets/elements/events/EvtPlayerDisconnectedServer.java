...
public class EvtPlayerDisconnectedServer extends SkriptEvent {
    ...
    static {
        ...
        EventValues.registerEventValue(PlayerDisconnectedServerEvent.class, OfflinePlayer.class,
                event -> event.getPlayer(), 0);
        EventValues.registerEventValue(PlayerDisconnectedServerEvent.class, SpigotServer.class,
                event -> event.getServer(), 0);
    }
