...
public class EvtPlayerConnectedServer extends SkriptEvent {
    ...
    static {
        ...
        EventValues.registerEventValue(PlayerConnectedServerEvent.class, OfflinePlayer.class, event -> event.getPlayer(), 0);
        EventValues.registerEventValue(PlayerConnectedServerEvent.class, SpigotServer.class, event -> event.getServer(), 0);
    }
